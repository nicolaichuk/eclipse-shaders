...
public class CgScanner extends ShaderFileScanner {
	...
	static final String functions[] = { "_SEQ", "_SGE", "_SGT", "_SLE", "_SLT",
			...
			"isnan", "lit","ldexp", "log", "log2", "log10", "max", "min", "mix",
			"mul", "lerp", "modf", "noise", "pow", "radians", "round", "rsqrt",
			"sign", "sin", "sinh", "smoothstep", "step", "sqrt", "tan", "tanh",
			"distance", "fresnel", "length", "normalize", "reflect",
			"reflectn", "refract", "refractn", "tex1D", "f1tex1D", "f2tex1D",
			"f3tex1D", "f4tex1D", "h1tex1D", "h2tex1D", "h3tex1D", "h4tex1D",
			"x1tex1D", "x2tex1D", "x3tex1D", "x4tex1D", "tex1Dbias",
