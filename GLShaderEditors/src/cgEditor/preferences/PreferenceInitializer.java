...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		{
			PreferenceConverter.setDefault(store, PreferenceConstants.PREFERENCES[i][1], (RGB)PreferenceConstants.DEFAULTPREFERENCES[i][0]);
			store.setDefault(PreferenceConstants.PREFERENCES[i][2], (Integer)PreferenceConstants.DEFAULTPREFERENCES[i][1]);
		}
	}
